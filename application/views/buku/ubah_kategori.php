    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <?php foreach ($kategori as $k) { ?> 
                <form action="<?= base_url('buku/ubahKategori'); ?>" menthod="post">
                    ...
                    <div class="form-group">
                        <input type="button" class="from-control form-control-user btn btn-dark col-lg-3 mt-3" value="Kembali" onclick="window.history.go(-1)">
                        <input type="submit" class="form-control form-contoh-user btn btn-primary col-lg-3 mt-3" value="Update">
                    </div>
                </form>
            <?php } ?>
        </div>
